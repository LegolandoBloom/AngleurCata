...
local logoTable = {
    youtube = "Interface/AddOns/AngleurCata/images/youtube.png",
    kofi = "Interface/AddOns/AngleurCata/images/kofi.png",
    patreon = "Interface/AddOns/AngleurCata/images/patreon.png"
}
