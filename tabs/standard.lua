function Angleur_SetTab1(self)
    ...
    self.fishingMethod.oneKey.icon:SetTexture("Interface/AddOns/AngleurCata/images/onekeyicon.png")
    self.fishingMethod.doubleClick.icon:SetTexture("Interface/AddOns/AngleurCata/images/doubleclickicon.png")
    ...
    --[[
        ...
        newFeatureTexture:SetTexture("Interface/AddOns/AngleurCata/images/newfeature.png")
    ]]--
end
